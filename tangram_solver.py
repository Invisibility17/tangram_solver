...
def solve_tangram(identifier):
    filename = "tangram{}.png".format(identifier)
    ...
    image_processing.visualize(filename, "resolved{}.jpg".format(identifier), nodes, edges)
    image_processing.bw_visualize(filename, "nodes_edges{}.png".format(identifier), nodes, edges)
    large_triangles = []
    medium_triangles = []
    small_triangles = []
    parallelograms = []
    ...
    image_processing.fill_in_solution(filename, "solved{}.jpg".format(identifier), polygons)
